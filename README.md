...
| Video | Description |
|---|---|
| <a href="https://youtu.be/8IScEH0ZJxA"><img src="https://img.youtube.com/vi/8IScEH0ZJxA/maxresdefault.jpg" alt="CV Explorer Demo" width="400"></a> | **[Exploring Mozilla Common Voice with CV Explorer](https://youtu.be/8IScEH0ZJxA)** <br> Introducing CV Explorer — browse and listen to 1.8M+ real voice clips from the Mozilla Common Voice dataset, filtered by language, gender, and age. |
