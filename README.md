...
| Video | Description |
|---|---|
| <a href="https://www.youtube.com/watch?v=8IScEH0ZJxA"><img src="https://img.youtube.com/vi/8IScEH0ZJxA/maxresdefault.jpg" alt="Common Voice Explorer Demo" width="400"></a> | **[Exploring Mozilla Common Voice with Common Voice Explorer](https://www.youtube.com/watch?v=8IScEH0ZJxA)** <br> Introducing Common Voice Explorer — browse and listen to 1.8M+ real voice clips from the Mozilla Common Voice dataset, filtered by language, gender, and age. |
